...
![](./掌柜问数.assets/image-20260121184748743-1785308010993-2.png)
...
![](./掌柜问数.assets/image-20260208173519231.png) 
...
![image-20260302144433733](./掌柜问数.assets/image-20260302144433733.png)
...
![image-20260302145219771](./掌柜问数.assets/image-20260302145219771.png)
...
![image-20260207140320440](./掌柜问数.assets/image-20260207140320440.png)

具体示例如下图所示：

![](./掌柜问数.assets/image-20260208173548508.png)
...
<img src="./掌柜问数.assets/image-20260121203227857.png" alt="image-20260121203227857" style="zoom: 50%;" />

具体示例如下图所示：

 ![](./掌柜问数.assets/image-20260208173614373.png)

### 2.3.4 全文索引

本项目使用 Elasticsearch 作为全文检索引擎，全文索引主要用于对**字段取值**进行检索与匹配，索引内容以各类维度值为主，具体如下：

<img src="./掌柜问数.assets/image-20260121204009373.png" alt="image-20260121204009373" style="zoom:80%;" />

具体示例如下图所示：

![](./掌柜问数.assets/image-20260208173647157.png)

## 2.4 问数智能体

本项目的智能体主体基于Langgraph构建，具体结构如下图所示：

![image-20260302160651463](./掌柜问数.assets/image-20260302160651463.png)
...
![image-20260121215240284](./掌柜问数.assets/image-20260121215240284.png)
...
![image-20260302164313014](./掌柜问数.assets/image-20260302164313014.png)

打开Windows PowerShell：

![image-20260302164430508](./掌柜问数.assets/image-20260302164430508.png)
...
![image-20260302165403928](./掌柜问数.assets/image-20260302165403928.png)
...
<img src="./掌柜问数.assets/image-20260121223015280.png" alt="image-20260121223015280" style="zoom:80%;" />
...
![image-20260302192049010](./掌柜问数.assets/image-20260302192049010.png)
...
> [!warning]
>
> **此指南种的`langchain_huggingface`已不建议使用，下面官方文档有最新的调用方式（langchain-openai）**
...
class EmbeddedClientManager:
    ...
    def init(self):
        self.embeddings = OpenAIEmbeddings(
            ...
            api_key=SecretStr("unused"), #虽然不用，但一定要写
...
[Index and search data using Elasticsearch APIs | Elasticsearch Guide [8.19\] | Elastic](https://www.elastic.co/guide/en/elasticsearch/reference/8.19/getting-started.html)
...
> 个人理解：
>
> 1. yaml配置文件中有表信息和列信息，分别读取之后存入mysql，
> 2. 列信息的一些字段description alis之类的存入向量数据库
> 3. 列信息的一些字段的具体取值，从数据仓库里查出来存入es
...
![image-20260207142744497](./掌柜问数.assets/image-20260208173356129.png)
...
![image-20260302160651463](./掌柜问数.assets/image-20260302160651463-1779027386371.png)
...
![image-20260311204011515](./掌柜问数.assets/image-20260311204011515-1779027386371.png)
...
![image-20260312162206045](./掌柜问数.assets/image-20260312162206045-1779027386371.png)
...
![image-20260312164049033](./掌柜问数.assets/image-20260312164049033-1779027386371.png)
...
![image-20260312185315752](./掌柜问数.assets/image-20260312185315752-1779027386371.png)
...
![image-20260207161919313](./掌柜问数.assets/image-20260207161919313-1779027386372.png)
